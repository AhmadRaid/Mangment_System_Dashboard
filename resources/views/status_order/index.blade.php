                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="center">
                            <a
                                ...
                                data-placement="left"
                                title="تعديل"
                                href="{{route('orderStatus.edit',$status->id)}}"
                            >
                            ...
                            <a
                                ...
                                title="حذف "
                                href="{{route('orderStatus.delete',$status->id)}}"
                            >
