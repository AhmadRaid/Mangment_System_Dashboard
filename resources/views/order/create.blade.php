                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-between pt-3">
                        ...
                        <div class="form-group col-md-6 pt-md-0 pt-3">
                            ...
                            <select name="governorate_id" id="customer-state" class="form-control form-control-sm">
                                @foreach($governorate as $gov)
                                    <option value="{{$gov->id}}"
                                            data-delivery="{{$gov->commission}}">{{$gov -> name}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-6 pt-3">
                            ...
                            <input name="address" id="customer-place" class="form-control form-control-sm"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card expand mt-3">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="bg-warning msg p-1 mt-1" style="width: 150px;margin-right : 15px; display : none">
                            أدخل قيمة صحيحة
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <select name="order_status_id" id="request-status" class="form-control form-control-sm">
                                @foreach($status as $status_order)
                                    <option value="{{$status_order->id}}">{{$status_order -> name}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-6 mb-3">
                            ...
                            <textarea name="internal_notes" id="internal-notes" class="form-control form-control-sm"
                                      rows="5"></textarea>
                        </div>
                    </div>
                    <div class="row mt-5 ">
                        <div class="radio mt-3 col-md-6 ask">
                            ...
                            <input type="radio" name="shipping_method" id="free" value="0" checked/>
                            <label for="free">مجاني</label>
                            <input type="radio" name="shipping_method" id="payed" value="1"/>
                            <label for="payed">مدفوع</label>
                            <div class="ask-box mt-3 hidden">
                                <div class="card">
                                    <div class="card-body">
                                        <h6>قيمة التوصيل : <span class="text-danger delivery-commission">5</span></h6>
                                        ...
                                        <h6> سعر المنتج : <span
                                                class=" text-danger original-price">لم يتم تحديد القيمة بعد</span></h6>
                        ...
                        <div class="radio mt-3 col-md-6 ask">
                            ...
                            <input type="radio" name="delivery" id="no" value="0" checked/>
                            ...
                            <div class="ask-box mt-3 hidden card card-body">
                                <div class="d-flex flex-sm-column flex-lg-row align-items-center">
                                    ...
                                    <span class="btn btn-success mt-2" onclick="addDiscount(event)">إضافة خصم</span>
                                </div>
                                <div class="bg-warning p-1 mt-2 discount-msg" style="width: 180px;display : none">لم تقم
                                    بادخال اي منتج بعد
                                </div>
                                <div class="discountInfo hidden mt-5 ">
                                    <h6> السعر قبل الخصم : <span
                                            class="text-danger before-discount">لم يتم تحديد القيمة بعد</span>
                                    </h6>
                                    <h6> السعر بعد الخصم : <span
                                            class="text-danger after-discount">لم يتم تحديد القيمة بعد</span>
                                    </h6>
                    ...
                    <div class="footer p-3 mt-5"
                         style="background-color: #eee;box-shadow:0 0 5px rgba(0, 0, 0, 0.3)">
                        <h6>السهر النهائي بعد العمليات السابقة : </h6>
